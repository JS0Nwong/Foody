...
import {LuHeading1, LuHeading2} from  'react-icons/lu/index'
  ...
  return (
    <div className="dropdown" ref={dropDownRef}>
      ...
      <IconButton className="item" onClick={formatBulletList}>
        <FormatListBulletedIcon className="icon bullet-list" />
        <span className="text">Bullet List</span>
        {blockType === "ul" && <span className="active" />}
      </IconButton>
      <IconButton className="item" onClick={formatNumberedList}>
        <FormatListNumberedIcon className="icon numbered-list" />
        <span className="text">Numbered List</span>
        {blockType === "ol" && <span className="active" />}
      </IconButton>
      <IconButton className="item" onClick={formatQuote}>
        <FormatQuoteIcon className="icon quote" />
        <span className="text">Quote</span>
        {blockType === "quote" && <span className="active" />}
      </IconButton>
      <IconButton className="item" onClick={formatCode}>
      ...
      {blockType === "code" ? (
        <>
          <Select
            ...
            value={codeLanguage}
          />
          <ExpandMoreIcon className="chevron-down inside" />
        </>
      ) : (
        <>
          <IconButton
          ...
          >
            <FormatAlignLeftIcon className="format left-align" />
          </IconButton>
          <IconButton
            onClick={() => {
          ...
          >
            <FormatAlignCenterIcon className="format center-align" />
          </IconButton>
          <IconButton
            onClick={() => {
          ...
          >
            <FormatAlignRightIcon className="format right-align" />
          </IconButton>
            ...
            >
              <FormatAlignJustifyIcon className="format justify-align" />
            </IconButton>{" "}
          </>
      )}
    </div>
